...
function ProjCards({ title, description, authors }) {
  return (
    <div className="bg-zinc-700 text-xl flex flex-col justify-around rounded-md w-[22.5em] my-4 h-64 py-4 px-2 hover:scale-[1.01] hover:shadow-xl transition-all">

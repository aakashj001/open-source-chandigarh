...
function TestCards({transform, name, designation}) {
  return (
    <div className={`lg:flex-[0.3_0_0%] rounded my-5 mx-10 lg:mx-0 bg-neutral-800 hover:scale-[1.02] transition ${transform ? 'h-auto lg:h-80 md:h-64' : 'h-auto md:h-64'} text-white px-8 py-4 flex flex-col justify-between`}>
